...
resource "aws_sesv2_contact_list" "fakeout_subscribers" {
  ...
  topic {
    ...
    topic_name                  = "weekly-challenge"
    description                 = "Receive notifications when a new weekly challenge is available."
  }
}
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Hello,</p>
            <p>A new weekly challenge is available on FakeOut! Test your AI detection skills and see if you can spot the fake.</p>
            <p>This week's challenge features new image and video pairs generated by the latest AI models. Can you tell what's real?</p>
